...
import { cmdDisplays } from "./common.js";
import { findByProps } from "@vendetta/metro";
import { before } from "@vendetta/patcher";
import { sendTextMessage as sendText } from "./common.js";
import { storage } from "@vendetta/plugin";
import { commands } from "@vendetta";
import { getUwuifier } from "./uwuifier/index.js";
import { makeDefaults } from "./common.js";
const patches = [];
      ...
      commands.registerCommand(
        cmdDisplays({
          ...
          execute: (rawArgs) => {try{
            ...
            const output = getUwuifier(storage).uwuifySentence(input);
    ...
    patches.push(
      before("sendMessage", Messages, (args) => {
        if (storage['settings']["convert_messages"] && !args[1]?._command_output)
          args[1].content = getUwuifier(storage).uwuifySentence(args[1].content);
      }),
    );
  },
};
