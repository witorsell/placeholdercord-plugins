...
Spoofs your Android device info (like manufacturer and model) through the **Native Bridge** (`window.placeholder.native`).

### Install

> https://witorsell.github.io/placeholdercord-plugins/DeviceSpoofer/
